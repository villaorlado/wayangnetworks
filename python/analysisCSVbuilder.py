...
for k,v in windowTypes.iteritems():	
	...
	for key,value in networkTypes.iteritems(): #here key is the name of the networkType and value is the related information
		...
		with open("../inputForAnalysis/" + key + "_" + k + "_forAnalysis.txt", "w") as file:
...
with open("../inputForAnalysis/uniquePlaces.csv", "w") as file:
